...
<body>
  ...
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col-lg-6 col-md-6 mb-4" style="cursor: pointer;">
        <div class="card h-100">
          <img class="card-img-top" src="../img/grammatica.png" alt="">
          <div class="card-body">
            <h4 class="card-title">Grammatica</h4>
            <p class="card-text">Maak hier grammatica opdrachten.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-4" style="cursor: pointer;">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">Spelling</h4>
            <p class="card-text">Maak hier spelling opdrachten.</p>
          </div>
        </div>
      </div>
